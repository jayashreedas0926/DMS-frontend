...
import { FileTextOutlined, ShoppingCartOutlined, ReloadOutlined, DollarOutlined } from "@ant-design/icons";
...
const dashboardJSON = {
  ...
  quickActions: [
    ...
    { title: "Shipment #789", subtitle: "Expected: 03-Oct-2025", tag: "Nearby" },
    { title: "Invoice #234", subtitle: "Due in 2 days", tag: "Payment Pending" },
    { title: "Delivery #321", subtitle: "Location: Nearby Warehouse", tag: "Nearby" },
  ],
};
...
const iconMap = {
  ...
  ShoppingCartOutlined: <ShoppingCartOutlined className="text-amber-700 text-2xl" />,
  ...
  return (
    <div className="p-2">
      ...
      <Row gutter={16} className="mb-6">
        <Col span={12}>
          <Card title={<span className="text-amber-700 font-bold">Purchase Contracts Evolution</span>}>
        ...
        <Col span={12}>
          <Card title={<span className="text-amber-700 font-bold">Purchase Invoices Evolution</span>}>
            <ResponsiveContainer width="100%" height={250}>
      ...
      <Row gutter={16} className="mb-6">
        <Col span={12}>
          <Card title={<span className="text-amber-700 font-bold">Purchase Returns Breakdown</span>}>
            <ResponsiveContainer width="100%" height={220}>
              <PieChart>
                <Pie data={dashboardJSON.returnData} cx="50%" cy="50%" outerRadius={90} dataKey="value" label>
          ...
          <Card title={<span className="text-amber-700 font-bold">Quick Action</span>}>
            <Space direction="vertical" className="w-full">
              {dashboardJSON.quickActions.map((action, index) => (
                <div
                  key={index}
                  className={`flex justify-between items-center py-2 px-3 ${index !== dashboardJSON.quickActions.length - 1 ? "border-b border-amber-200" : ""}`}
                >
                  <div>
                    <p className="font-medium text-amber-700 text-sm m-0">{action.title}</p>
